...
def generar_analisis_ja4l_cliente_estadistico():
    ...
    print("\n" + "="*95)
    print(f"{'ESTADISTICA GLOBAL POR SISTEMA OPERATIVO':^95}")
    print("="*95)
    ...
    resumen_web_so.columns = [
        'Web', 'SO', 'Latencia_Media', 'Latencia_Desv', 'Latencia_Min', 'Latencia_Max', 'TTL_Moda', 'TTL_Media'
    ]
    
    print("\n" + "="*95)
    print(f"{'RESUMEN POR WEB Y SO (PRIMERAS 10 FILAS)':^95}")
    print("="*95)
...
if __name__ == "__main__":
    generar_analisis_ja4l_cliente_estadistico()