...
#
# Descripción:
#   Implementa el estudio de trazabilidad cruzada, clasificando el sistema operativo del servidor mediante el
#   TTL observado y cruzándolo con el sistema operativo del cliente y el navegador empleado.
...
def analizar_cruce_so():
    ...
    try:
        ...
        # Crear la tabla de cruce: SO del cliente -> Navegador -> SO que responde
        ...
        # index=False porque ya hicimos reset_index
        df_salida.to_csv(ruta_csv, sep=';', index=False)
